...
# 钱包地址
worker_wallet_address=9RqzsngWbSBwZwPk84AkV83tsDNQQJipD1BEfFNugMHD
# 逻辑核心数
...
start_process() {
    ...
    do   
        ...
        local command_base="./ore-mine-pool-linux worker --alias BLACKPINK --core-range ${core_range} --worker-wallet-address ${worker_wallet_address} >> worker.log 2>&1"
